...
function Section4() {
    return (
        <div id='section4'>
            <section
                                            className="elementor-section elementor-top-section elementor-element elementor-element-6a95ea5 elementor-section-stretched elementor-section-height-min-height elementor-section-items-top elementor-section-boxed elementor-section-height-default"
                                            data-id="6a95ea5"
                                        ...
                                        >
                                            <div className="elementor-container elementor-column-gap-default">
                                                <div className="elementor-row">
                                                    <div
                                                        className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-7319230"
                                                        data-id="7319230"
                                                    ...
                                                    >
                                                        <div className="elementor-column-wrap elementor-element-populated">
                                                            <div className="elementor-widget-wrap">
                                                                <div
                                                                    className="elementor-element elementor-element-082ab5b elementor-widget__width-auto elementor-absolute elementor-hidden-phone elementor-widget elementor-widget-image"
                                                                    data-id="082ab5b"
                                                                    ...
                                                                    <div className="elementor-widget-container">
                                                                        <div className="elementor-image">
                                                                            <img
                                                                                width="380"
                                                                                height="410"
                                                                                src="upload/icon-coffee-red-shadow-e1592448757666.png"
                                                                    ...
                                                                    <div className="elementor-widget-container">
                                                                        <div className="elementor-image">
                                                                            <img
                                                                                width="1440"
                                                                                height="960"
                                                                                src="upload/jonathan-borba-O2fAWP7uDSQ-unsplash.jpg"
                                                    ...
                                                    <div
                                                        className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-5965cce animation"
                                                        data-id="5965cce"
                                                        data-element_type="column"
                                                    ...
                                                    >
                                                        <div className="elementor-column-wrap elementor-element-populated">
                                                            <div className="elementor-widget-wrap">
                                                                <div
                                                                    className="elementor-element elementor-element-83c7b76 elementor-widget__width-inherit elementor-widget elementor-widget-heading"
                                                                    data-id="83c7b76"
                                                                    data-element_type="widget"
                                                                ...
                                                                >
                                                                    <div className="elementor-widget-container">
                                                                        <h2 className="elementor-heading-title elementor-size-default">Craft Cofee</h2>
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    className="elementor-element elementor-element-1903258 elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                                    data-id="1903258"
                                                                    data-element_type="widget"
