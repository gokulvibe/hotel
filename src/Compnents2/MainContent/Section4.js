...
function Section4() {
    return (
        <div id='section4' className='d-block mx-auto' data-aos="zoom-in-up">
           <div className='container d-lg-flex mx-auto' style={{borderColor:"black"}}>
               <div className='col' style={{borderRadius:"2em",overflow:"hidden"}}>
                   <img src={img1} className="img-fluid" data-aos="zoom-in-right" style={{borderRadius:"2em",minWidth:"300px",minHeight:"300px"}} ></img>
               </div>
               <div className='col'>
