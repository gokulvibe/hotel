    ...
    return(
        <div classname="Box" style={{paddingTop:"25vh",paddingBottom:"40vh"}}>
              <form method="post" action="contactform/contactengine.php" class="forms-input" id="feed">
                   ...
                   <TextareaAutosize name="feedback" id="feedback" placeholder='Type here...' style={{display:"block",width:"30vw",height:"40vh",color:"black",minWidth:"275px",marginLeft:"auto",marginRight:"auto",borderRadius:"2em"}}/>
